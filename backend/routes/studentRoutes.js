...
const { registerStudent, getStudent, getAllStudents, updateStudent, deleteStudent, csvStudent, getStudentById } = require('../controllers/studentController');
const getStudentMiddleware = require('../utils/getStudentById');
...
router.post('/update-student/:id', [
    ...
    check('hostel', 'Hostel is required').not().isEmpty()
], getStudentMiddleware, updateStudent);
