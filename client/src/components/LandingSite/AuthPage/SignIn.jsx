  ...
  let login = async (event) => {
    ...
    if (result.success) {
      if (!result.data.user.isAdmin) {
        ...
        let student = await fetch("http://localhost:3001/api/student/get-student", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        if (studentResult.success) {
          ...
          console.log("Not a Student: " + studentResult.errors)
          toast.error(
            studentResult.errors[0].msg, {
            position: "top-right",
            autoClose: 3000,
        ...
        toast.error(
          'It looks like you are an admin. Click here to login.', {
          position: "top-right",
          autoClose: 3000,
          hideProgressBar: false,
          closeOnClick: true,
